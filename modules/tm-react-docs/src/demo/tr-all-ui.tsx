...
import {
    ...
    DashboardIcon, ExpandMoreIcon, ListIcon, PeopleIcon, ReportIcon, RowingIcon,
    Table,
    TableBody,
    TableCell,
    TableRow, TextField
...
import TRDropdown from "react-mui-ui/ui/tr-dropdown";
import TRDialog from "react-mui-ui/ui/tr-dialog";
import TRAlertDialog from "react-mui-ui/ui/tr-alert-dialog";
...
export default class AllUiDemo extends TRReactComponent<DemoProps, DemoState> {
    ...
    render(){
        ...
        // Dropdown Action
        let dropdownAction = new TRDropdownDataHelper();
        dropdownAction.add("profile", "Profiles");
